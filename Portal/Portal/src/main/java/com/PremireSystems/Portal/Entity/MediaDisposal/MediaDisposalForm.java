...
@Entity
public class MediaDisposalForm {
    @Id
...
//    private String category;
    ...
    public MediaDisposalForm(){}

    public MediaDisposalForm(Long id, String owner, String department, String reason, String model, String serialNumber, String digitalHardware, String digitalSoftware, String physicalCategory, String informationClassification, String backUp, String sanitizationMethod, String disposedMedia, String performedBy, String validatedBy, LocalDate performedDate, LocalDate validatedDate) {
        this.id = id;
        this.owner = owner;
