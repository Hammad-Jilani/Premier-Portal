...
public class SapAccessForm {
    ...
    @ElementCollection
    @CollectionTable(name="sap_location",joinColumns=@JoinColumn(name="sap_id"))
    private List<String> location;

    @ElementCollection
    @CollectionTable(name = "sap_area_office",joinColumns = @JoinColumn(name = "sap_id"))
    ...
    @ElementCollection
    @CollectionTable(name = "plant",joinColumns = @JoinColumn(name="sap_id"))
    private List<String> plant;

    @ElementCollection
    @CollectionTable(name = "sales_organization",joinColumns = @JoinColumn(name="sap_id"))
    private List<String> salesOrganization;

    @ElementCollection
    @CollectionTable(name = "distribution_channel",joinColumns = @JoinColumn(name="sap_id"))
    private List<String> distributionChannel;

    @ElementCollection
    @CollectionTable(name = "division",joinColumns = @JoinColumn(name="sap_id"))
    private List<String> division;

    @ElementCollection
    @CollectionTable(name = "sales_office",joinColumns = @JoinColumn(name="sap_id"))
